  ...
  1: {
    ...
    slides: [
      ...
      },
      {
        ...
        subtext: 'When we cut something into MORE pieces, each piece gets SMALLER. So 1/4 < 1/2 — even though 4 > 2!',
        showNumberLine: true,
        fractionA: { numerator: 1, denominator: 2 },
    ...
    checkQuestion: {
      ...
      options: ['True', 'False'],
      correct: 1,
      explanation: 'False! A bigger denominator means SMALLER pieces. 1/8 < 1/3 because you\'re cutting into 8 tiny pieces instead of 3 bigger ones.',
    },
  },
  2: {
...
export default function PhaseLearn({ sessionNumber, onComplete }) {
