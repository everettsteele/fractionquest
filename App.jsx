...
import { loadStudent, saveStudent, advancePhase } from './lib/storage.js'
...
export default function App() {
  ...
  function handlePracticeComplete() {
    if (activeSession >= 3) {
      ...
      // Sessions 1-2: practice → done, advance to next session, back to map
      ...
      const nextSession = Math.min(activeSession + 1, 5)
      const final = saveStudent({ ...updated, sessionHistory: sessions, currentSession: nextSession })
      setStudent(final)
      setView('map')
